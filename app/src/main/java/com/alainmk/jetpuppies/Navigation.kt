...
import com.alainmk.jetpuppies.utils.getMutableStateOf
...
sealed class Screen(val id: ScreenName) {
    ...
    data class Detail(val postId: Int) : Screen(ScreenName.DETAIL)
}
